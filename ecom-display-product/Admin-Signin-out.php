...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($myusername)) {
        echo "<script>alert('Username is required'); window.location.href = 'Admin-Signin-out.php'</script>";
        exit();
    }

   
    if (empty($mypassword)) {
        echo "<script>alert('Password is required'); window.location.href = 'Admin-Signin-out.php';</script>";
        exit();
    }
    ...
    if ($count == 1) {
        ...
        echo "<script>alert('Login Successful'); window.location.href = 'AdminDisplayProduct.php';</script>";
        exit(); 
    }
}
        ...
        <body>
            <div class="container">
                ...
                <div class="signin-signup">
                    ...
                    <form action="admin-signup.php" method="post" class="sign-up-form">
